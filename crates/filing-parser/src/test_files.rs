...
lazy_static! {
    pub static ref FILES: Vec<TestableFiling> = vec![
        ...
        TestableFiling {
            s3: String::from("edgar/data/1015383/0001079973-17-000690.txt"),
            path: String::from("examples/10-Q/input/0001079973-17-000690.txt"),
            header_inner_html: String::from("STATEMENT OF OPERATIONS"),
            match_type: MatchType::Regex
        },
        TestableFiling {
            s3: String::from("edgar/data/10254/0001564590-17-009385.txt"),
            path: String::from("examples/10-Q/input/0001564590-17-009385.txt"),
            header_inner_html: String::from("ONSOLIDATED STATEMENTS OF OPERATIONS"), // not a typo
