...
lazy_static! {
    pub static ref FILES: Vec<TestableFiling> = vec![
        TestableFiling {
            ...
            path: String::from("crates/filing-parser/examples/10-Q/input/0001193125-18-037381.txt"),
        ...
        TestableFiling {
            ...
            path: String::from("crates/filing-parser/examples/10-Q/input/0001000623-17-000125.txt"),
        ...
        TestableFiling {
            ...
            path: String::from("crates/filing-parser/examples/10-Q/input/0001437749-16-025027.txt"),
        ...
        TestableFiling {
            ...
            path: String::from("crates/filing-parser/examples/10-Q/input/0001004434-17-000011.txt"),
        ...
        TestableFiling {
            ...
            path: String::from("crates/filing-parser/examples/10-Q/input/0001185185-16-005721.txt"),
        ...
        TestableFiling {
            ...
            path: String::from("crates/filing-parser/examples/10-Q/input/0001437749-16-036870.txt"),
            header_inner_html: String::from(
        ...
        TestableFiling {
            ...
            path: String::from("crates/filing-parser/examples/10-Q/input/0001193125-16-454777.txt"),
            header_inner_html: String::from("Consolidated Statements of Income "),
        },
        TestableFiling {
            s3: String::from("edgar/data/1000697/0001193125-17-160261.txt"),
            path: String::from("crates/filing-parser/examples/10-Q/input/0001193125-17-160261.txt"),
            header_inner_html: String::from("CONSOLIDATED STATEMENTS OF OPERATIONS "),
        },
        TestableFiling {
            s3: String::from("edgar/data/1001288/0001001288-16-000069.txt"),
            path: String::from("crates/filing-parser/examples/10-Q/input/0001001288-16-000069.txt"),
        ...
        TestableFiling {
            ...
            path: String::from("crates/filing-parser/examples/10-Q/input/0001493152-17-009297.txt"),
