...
pub fn get_files() -> Vec<TestableFiling> {
    return vec![
        TestableFiling {
            ...
            table_element: r#"<table cellspacing="0" cellpadding="0" width="100%" border="0" align="center" style="background-color: red;" x-birb-income-statement-table="0">"#,
        ...
        TestableFiling {
            ...
            table_element: r#"<table cellpadding="0" cellspacing="0" style="background-color: red;" x-birb-income-statement-table="0">"#,
            income_statement_table_count: 2,
        },
        TestableFiling {
            s3: "edgar/data/1002037/0001437749-16-025027.txt",
            path: "examples/10-Q/input/0001437749-16-025027.txt",
            table_element: r#"<table id="TBL1155" cellspacing="0" cellpadding="0" border="0" style="background-color: red;" x-birb-income-statement-table="0">"#,
            income_statement_table_count: 2,
        },
        TestableFiling {
        ...
        TestableFiling {
            ...
            table_element: r#"<table id="z812e1f80f42848f48cfdf81d8682edfd" cellspacing="0" cellpadding="0" style="background-color: red;" x-birb-income-statement-table="0">"#,
            income_statement_table_count: 2,
        },
        TestableFiling {
        ...
        TestableFiling {
            ...
            table_element: r#"<table cellspacing="0" cellpadding="0" style="background-color: red;" x-birb-income-statement-table="0">"#,
            income_statement_table_count: 2
        },
        TestableFiling {
        ...
        TestableFiling {
            ...
            table_element: r#"<table id="ze4e14be6186a48a58a40f9d2654a9a34" cellspacing="0" cellpadding="0" style="background-color: red;" x-birb-income-statement-table="0">"#,
            income_statement_table_count: 2
        },
        TestableFiling {
            s3: "edgar/data/10254/0001564590-17-009385.txt",
            path: "examples/10-Q/input/0001564590-17-009385.txt",
            table_element: r#"<table border="0" cellspacing="0" cellpadding="0" align="center" style="background-color: red;" x-birb-income-statement-table="0">"#,
            income_statement_table_count: 2
        },
        TestableFiling {
            s3: "edgar/data/1027099/0001185185-16-005747.txt",
            path: "examples/10-Q/input/0001185185-16-005747.txt",
            table_element: r#"<table id="z1f37cd191a1742a59339b605e5b1593d" cellspacing="0" cellpadding="0" style="background-color: red;" x-birb-income-statement-table="0">"#,
            income_statement_table_count: 2
        },
        TestableFiling {
        ...
        TestableFiling { // this one is messy... two companies
            ...
            table_element: r#"<table id="6d37b329224548c18649e727b91c963c" cellspacing="0" cellpadding="0" style="background-color: red;" x-birb-income-statement-table="0">"#,
            income_statement_table_count: 4 // (it's a lot, but looks correct)
        },
        TestableFiling {
