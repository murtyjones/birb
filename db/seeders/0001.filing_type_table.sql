...
VALUES
    ...
    ('1-E/A', 'Notification under Regulation E by small business investment companies and business development companies (Amendment)'),
    ('1-E AD', 'Sales material filed pursuant to Rule 607 under Regulation E.'),
    ('1-E AD/A', 'Sales material filed pursuant to Rule 607 under Regulation E. (Amendment)'),
    ('2-E', 'Sales material filed pursuant to Rule 609 under Regulation E.'),
    ('2-E/A', 'Sales material filed pursuant to Rule 609 under Regulation E. (Amendment)'),
    ('10-12B', 'Initial general form for registration of a class of securities pursuant to section 12(b)'),
    ('10-12B/A', 'Initial general form for registration of a class of securities pursuant to section 12(b) (Amendment)'),
    ('10-12G', 'Initial general form for registration of a class of securities pursuant to section 12(g)'),
    ('10-12G/A', 'Initial general form for registration of a class of securities pursuant to section 12(g) (Amendment)'),
    ('10-D', 'Periodic distribution reports by Asset-Backed issuers pursuant to Rule 13a-17 or 15d-17'),
    ('10-D/A', 'Periodic distribution reports by Asset-Backed issuers pursuant to Rule 13a-17 or 15d-17 (Amendment)'),
    ('10-K/A', 'Annual report pursuant to section 13 and 15(d) (Amendment)'),
    ('10-KT', 'Transition report pursuant to Rule 13a-10 or 15d-10'),
    ('10-KT/A', 'Transition report pursuant to Rule 13a-10 or 15d-10 (Amendment)'),
    ('10-Q/A', 'Quarterly report pursuant to section 13 and 15(d) (Amendment)'),
    ('10-QT', 'Transition report pursuant to Rule 13a-10 or 15d-10'),
    ('10-QT/A', 'Transition report pursuant to Rule 13a-10 or 15d-10 (Amendment)'),
    ('11-K', 'Annual report of employee stock purchase, savings and similar plans'),
    ('11-K/A', 'Annual report of employee stock purchase, savings and similar plans (Amendment)'),
    ('11-KT', 'Transition report pursuant to Rule 13a-10 or 15d-10'),
    ('11-KT/A', 'Transition report pursuant to Rule 13a-10 or 15d-10 (Amendment)'),
    ('13F-HR', 'Initial Quarterly Form 13F Holdings report filed by institutional managers'),
    ('13F-HR/A', 'Initial Quarterly Form 13F Holdings report filed by institutional managers (Amendment)'),
    ('13F-NT', 'Initial Quarterly Form 13F Notice Report filed by institutional managers'),
    ('13F-NT/A', 'Initial Quarterly Form 13F Notice Report filed by institutional managers (Amendment)'),
    ('13H', 'Large Trader Registration Information Required of Large Traders Pursuant to the Securities Exchange Act of 1934 and Rule 13h-1 Thereunder. Initial Filing (13H)'),
    ('13H-Q', 'Large Trader Registration Information Required of Large Traders Pursuant to the Securities Exchange Act of 1934 and Rule 13h-1 Thereunder. Amended Filing (13H-Q)'),
    ('13H-A', 'Large Trader Registration Information Required of Large Traders Pursuant to the Securities Exchange Act of 1934 and Rule 13h-1 Thereunder. Annual Filing (13H-A)'),
    ('13H-I', 'Large Trader Registration Information Required of Large Traders Pursuant to the Securities Exchange Act of 1934 and Rule 13h-1 Thereunder. Inactive Status (13H-I)'),
    ('13H-R', 'Large Trader Registration Information Required of Large Traders Pursuant to the Securities Exchange Act of 1934 and Rule 13h-1 Thereunder. Reactivated Status (13H-R)'),
    ('13H-T', 'Large Trader Registration Information Required of Large Traders Pursuant to the Securities Exchange Act of 1934 and Rule 13h-1 Thereunder. Termination Filing (13H-T)'),
    ('144', 'Filing for proposed sale of securities under Rule 144'),
    ('144/A', 'Filing for proposed sale of securities under Rule 144 (Amendment)'),
    ('15-12B', 'Notice of termination of registration of a class of securities under Section 12(b)'),
    ('15-12B/A', 'Notice of termination of registration of a class of securities under Section 12(b) (Amendment)'),
    ('15-12G', 'Notice of termination of registration of a class of securities under Section 12(g)'),
    ('15-12G/A', 'Notice of termination of registration of a class of securities under Section 12(g) (Amendment)'),
    ('15-15D', 'Notice of suspension of duty to file reports pursuant to Section 13 and 15(d) of the Act'),
    ('15-15D/A', 'Notice of suspension of duty to file reports pursuant to Section 13 and 15(d) of the Act (Amendment)'),
    ('15F-12G', 'Notice of termination of a foreign private issuer''s registration of a class of securities under Section 12(g)'),
    ('15F-12G/A', 'Notice of termination of a foreign private issuer''s registration of a class of securities under Section 12(g) (Amendment)'),
    ...
    ('15F-15D/A', 'Notice of a foreign private issuers suspension of duty to file reports pursuant to Section 13 and 15(d) of the Act (Amendment)'),
    ('18-K', 'Annual report for foreign governments'),
    ('18-K/A', 'Annual report for foreign governments (Amendment)'),
    ('20-F', 'Annual and transition report of foreign private issuers pursuant to sections 13 or 15(d)'),
    ('20-F/A', 'Annual and transition report of foreign private issuers pursuant to sections 13 or 15(d) (Amendment)'),
    ('20FR12B', 'Form for initial registration of a class of securities of foreign private issuers pursuant to section 12(b)'),
    ('20FR12B/A', 'Form for initial registration of a class of securities of foreign private issuers pursuant to section 12(b) (Amendment)'),
    ('20FR12G', 'Form for initial registration of a class of securities of foreign private issuers pursuant to section 12(g)'),
    ('20FR12G/A', 'Form for initial registration of a class of securities of foreign private issuers pursuant to section 12(g) (Amendment)'),
    ('24F-2NT', 'Rule 24F-2 notice filed on Form 24F-2'),
    ('24F-2NT/A', 'Rule 24F-2 notice filed on Form 24F-2 (Amendment)'),
    ...
    ('25/A', 'Notification filed by issuer to voluntarily withdraw a class of securities from listing and registration on a national securities exchange (Amendment)'),
    ...
    ('25-NSE/A', 'Notification filed by national security exchange to report the removal from listing and registration of matured, redeemed or retired securities (Amendment)'),
    ('3', 'Initial statement of beneficial ownership of securities'),
    ('3/A', 'Initial statement of beneficial ownership of securities (Amendment)'),
    ('305B2', 'Application for designation of a new trustee under the Trust Indenture Act'),
    ('305B2/A', 'Application for designation of a new trustee under the Trust Indenture Act (Amendment)'),
    ('4', 'Statement of changes in beneficial ownership of securities'),
    ('4/A', 'Statement of changes in beneficial ownership of securities (Amendment)'),
    ('40-6B', 'Application under the Investment Company Act by an employee''s securities company'),
    ('40-6B/A', 'Application under the Investment Company Act by an employee''s securities company (Amendment)'),
    ...
    ('40-17F2/A', 'Initial certificate of accounting of securities and similar investments in the custody of management investment companies (Amendment)'),
    ...
    ('8-K12G3/A', 'Notification that a class of securities of successor issuer is deemed to be registered pursuant to Section 12(g) (Amendment)'),
    ('8-K15D5', 'Notification of assumption of duty to report by successor'),
    ('8-M', '8-M Filing'),
    ('9-M', '9-M Filing'),
    ('ABS-15G', 'ABS-15G Filing'),
    ...
    ('APP NTC', 'APP NTC Filing'),
    ('APP ORDR', 'APP ORDR Filing'),
    ...
    ('NSAR-BT/A', 'Transitional annual report filed on Form NSAR (Amendment)'),
    ...
    ('NT 20-F/A', 'Notice under Rule 12b25 of inability to timely file all or part of an annual report of form 20-F (Amendment)'),
    ...
    ('NT-NSAR/A', 'Notice under Exchange Act Rule 12b-25 of inability to timely file Form N-SAR (Amendment)'),
    ('NTFNCSR', ''),
    ('NTFNSAR', ''),
    ...
    ('X-17A-5/A', 'X-17A-5/A Filing (Amendment)'),
    ('10-K', 'Annual report pursuant to section 13 and 15(d)'),
    ('10-Q', 'Quarterly report pursuant to section 13 and 15(d)'),
    ('IRANNOTICE', ''),
    ('ABS-EE/A', ''),
    ('ABS-EE', ''),
    ('N-8F NTC', ''),
