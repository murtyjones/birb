...
declare module 'react-redux' {
  ...
  export type InferableComponentDecorator<TOwnProps> = <T extends ComponentType<TOwnProps>>(component: T) => T;
  ...
  export type Connect = <TStateProps = any, TDispatchProps = any, TOwnProps = any, TMergedProps = any, State = any>(
